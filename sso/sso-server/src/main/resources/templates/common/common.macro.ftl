...
<#macro commonHeader>
    <header class="main-header">
        <a href="${request.contextPath}/" class="logo">
            <span class="logo-mini"><b>FIRE</b></span>
            <span class="logo-lg"><b>FIRE SSO</b></span>
        </a>
...
<#macro commonFooter >
    <footer class="main-footer">
        Powered by <b>SSO</b> 1.1.1-SNAPSHOT
        <div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2020-${.now?string('yyyy')} &nbsp;
                <a href="http://www.fireflynay.top/" target="_blank" >首页</a>
                &nbsp;
                <a href="http://www.fireflynay.top/" target="_blank" >主站</a>
